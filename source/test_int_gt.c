...
int _array_increment_by_limits(gt_int_t *arr, size_t length, gt_int_t *lower_lim, gt_int_t *upper_lim);
int _gt_increment_transposed(gt_int_t *pattern_tr, gt_int_t *min_pattern_tr, size_t length);

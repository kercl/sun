 ...
 */
  ...
  { PyObject* __pyx_temp = PyNumber_InPlaceMultiply(__pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_temp)) __PYX_ERR(0, 155, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_temp);
  ...
  __pyx_v_self->_cache_lowering = ((PyObject*)__pyx_t_4);
  __pyx_t_4 = 0;
